...
export declare const defaultIntegrations: (Console | Http | OnUncaughtException | OnUnhandledRejection | ContextLines | LinkedErrors | Modules | Context | RequestData | LocalVariables | Undici | CoreIntegrations.InboundFilters | CoreIntegrations.FunctionToString)[];
/**
